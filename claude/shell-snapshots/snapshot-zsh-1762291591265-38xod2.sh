...
if ! command -v rg >/dev/null 2>&1; then
  alias rg='/home/helio/.vscode/extensions/anthropic.claude-code-2.0.31-linux-x64/resources/native-binary/claude --ripgrep'
fi
export PATH=/home/helio/.npm-global/bin\:/home/helio/.local/bin\:/usr/local/sbin\:/usr/local/bin\:/usr/bin\:/usr/bin/site_perl\:/usr/bin/vendor_perl\:/usr/bin/core_perl
