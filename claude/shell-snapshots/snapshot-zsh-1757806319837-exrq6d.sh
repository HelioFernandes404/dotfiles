...
export PATH=/home/helio/Cognitive-Nexus/DevOps/ansible-project/.venv/bin\:/usr/local/sbin\:/usr/local/bin\:/usr/bin\:/usr/bin/site_perl\:/usr/bin/vendor_perl\:/usr/bin/core_perl
