...
export PATH=/home/helio/alvorada-tecno/cogcs/k9s-config__cogcs/.venv/bin\:/home/helio/.local/bin\:/usr/local/sbin\:/usr/local/bin\:/usr/bin\:/usr/bin/site_perl\:/usr/bin/vendor_perl\:/usr/bin/core_perl
