...
if ! command -v rg >/dev/null 2>&1; then
  alias rg='/home/helio/.local/share/claude/versions/2.0.25 --ripgrep'
fi
export PATH=/home/helio/systemframe/webhooks-alertmanager/.venv/bin\:/home/helio/.local/bin\:/home/helio/systemframe/webhooks-alertmanager/.venv/bin\:/home/helio/.local/bin\:/usr/local/sbin\:/usr/local/bin\:/usr/bin\:/usr/bin/site_perl\:/usr/bin/vendor_perl\:/usr/bin/core_perl\:/home/helio/.vscode/extensions/ms-python.debugpy-2025.14.1-linux-x64/bundled/scripts/noConfigScripts\:/home/helio/.config/Code/User/globalStorage/github.copilot-chat/debugCommand
