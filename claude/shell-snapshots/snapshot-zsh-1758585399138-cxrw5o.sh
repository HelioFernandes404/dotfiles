...
if ! command -v rg >/dev/null 2>&1; then
  alias rg='/home/helio/.local/share/claude/versions/1.0.120 --ripgrep'
fi
export PATH=/home/helio/Cognitive-Nexus/DevOps/ansible-project/.venv/bin\:/home/helio/.local/bin\:/usr/local/sbin\:/usr/local/bin\:/usr/bin\:/usr/bin/site_perl\:/usr/bin/vendor_perl\:/usr/bin/core_perl
