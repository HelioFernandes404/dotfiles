...
export PATH=/home/helio/.local/bin\:/home/helio/.local/bin\:/usr/local/sbin\:/usr/local/bin\:/usr/bin\:/usr/bin/site_perl\:/usr/bin/vendor_perl\:/usr/bin/core_perl\:/home/helio/.config/Code/User/globalStorage/github.copilot-chat/debugCommand
