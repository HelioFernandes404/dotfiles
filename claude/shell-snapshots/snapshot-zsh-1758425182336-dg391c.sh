...
export PATH=/home/helio/heliofernandes404/InfranGen/.venv/bin\:/home/helio/.local/bin\:/usr/local/sbin\:/usr/local/bin\:/usr/bin\:/usr/bin/site_perl\:/usr/bin/vendor_perl\:/usr/bin/core_perl
